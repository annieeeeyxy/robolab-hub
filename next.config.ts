...
const nextConfig: NextConfig = {
  ...
  async redirects() {
    return [
      ...
      { source: "/roboprompt/members", destination: "/#team", permanent: true },
      { source: "/roboprompt/members/:slug", destination: "/#team", permanent: true },
      ...
      { source: "/members", destination: "/#team", permanent: false },
      { source: "/members/:slug", destination: "/#team", permanent: false },
