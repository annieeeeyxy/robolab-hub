...
export const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    referenceMaterialsOptional: "Reference materials (optional)",
    addFiles: "Add files",
    referenceMaterialsHint: "URDF/xacro, datasheets, existing code, or a project zip — anything that helps.",
    referenceFileDescriptionPlaceholder: "What is this file? (optional)",
    removeReferenceFile: "Remove {filename}",
    remove: "Remove",
    uploadedPhotoAlt: "Uploaded robot arm photo {number}",
  ...
  es: {
    ...
    referenceMaterialsOptional: "Materiales de referencia (opcional)",
    addFiles: "Añadir archivos",
    referenceMaterialsHint: "URDF/xacro, hojas de datos, código existente o un zip del proyecto: cualquier cosa que ayude.",
    referenceFileDescriptionPlaceholder: "¿Qué contiene este archivo? (opcional)",
    removeReferenceFile: "Quitar {filename}",
    remove: "Quitar",
    uploadedPhotoAlt: "Foto {number} del brazo robótico subida",
  ...
  fr: {
    ...
    referenceMaterialsOptional: "Documents de référence (facultatif)",
    addFiles: "Ajouter des fichiers",
    referenceMaterialsHint: "URDF/xacro, fiches techniques, code existant ou archive du projet : tout ce qui peut aider.",
    referenceFileDescriptionPlaceholder: "Que contient ce fichier ? (facultatif)",
    removeReferenceFile: "Retirer {filename}",
    remove: "Retirer",
    uploadedPhotoAlt: "Photo {number} du bras robotique importée",
  ...
  zh: {
    ...
    referenceMaterialsOptional: "参考资料（可选）",
    addFiles: "添加文件",
    referenceMaterialsHint: "URDF/xacro、数据手册、现有代码或项目压缩包——任何有帮助的资料均可。",
    referenceFileDescriptionPlaceholder: "这个文件是什么？（可选）",
    removeReferenceFile: "移除 {filename}",
    remove: "移除",
    uploadedPhotoAlt: "已上传的机械臂照片 {number}",
    removePhoto: "移除照片",
    thinking: "思考中…",
    loading: "加载中",
    changeLanguage: "切换语言",
